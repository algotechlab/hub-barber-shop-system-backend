...
pagination_arguments_employees.add_argument("current_page", help="Current Page", default=1, type=int, required=False)
pagination_arguments_employees.add_argument("rows_per_page", help="Rows per Page", default=10, type=int, required=False)
pagination_arguments_employees.add_argument("order_by", help="Order By", default="", type=str, required=False)
pagination_arguments_employees.add_argument("sort_by", help="Sort By", default="", type=str, required=False)
pagination_arguments_employees.add_argument("filter_by", help="Filter By", default="", type=str, required=False)
pagination_arguments_employees.add_argument("filter_value", help="Filter Value", default="", type=str, required=False)
...
payload_add_employees = employee_ns.model(
    "User",
    {
        ...
        'date_of_birth': fields.DateTime(dt_format='%Y-%m-%d', description='The person\'s birth date in %Y-%m-%d format'),
        "nickname": fields.String(required=True, example="Nickname", max_length=300),
...
payload_update_employees = employee_ns.model(
    "User",
    {
        ...
        'date_of_birth': fields.DateTime(dt_format='iso8601', description='The person\'s birth date in ISO 8601 format'),
        "nickname": fields.String(required=False, example="Nickname", max_length=300),
        "email": fields.String(required=False, example="Email", max_length=300),        
