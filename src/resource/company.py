...
payload_add_companies = companies_ns.model(
    ...
    {
        "name": fields.String(
            required=True, example="Company name", max_length=120
        ),
        "email": fields.String(
            required=True, example="Company email", max_length=120
        ),
        "phone_number": fields.String(
            required=True, example="Company phone number", max_length=40
        ),
        "color": fields.String(
            required=False, example="Company color", max_length=20
        ),
        "slug": fields.String(
            required=True, example="company-slug", max_length=120
        ),
...
payload_update_companies = companies_ns.model(
    ...
    {
        "name": fields.String(
            required=False, example="Company name", max_length=120
        ),
        "email": fields.String(
            required=False, example="Company email", max_length=120
        ),
        "phone_number": fields.String(
        ...
        "slug": fields.String(
            required=False, example="company-slug", max_length=120
        ),
...
class CompanyResource(Resource):
    ...
    def get(self):
        ...
        try:
            ...
            return CompanyService(user_id=user_id).list_companies(
    ...
    def post(self):
        ...
        try:
            user_id = request.headers.get("Id", request.environ.get("Id"))
            return CompanyService(user_id=user_id).add_company(
                request.get_json()
            )
        except Exception:
            return (
...
class CompanyResourceManagerId(Resource):
    ...
    def put(self, company_id: int):
        ...
        try:
            user_id = request.headers.get("Id", request.environ.get("Id"))
            return CompanyService(user_id=user_id).update_company(
