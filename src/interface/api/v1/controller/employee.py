...
class EmployeeController:
    ...
    async def list_employees(
        ...
        return await self.employee_use_case.list_employees(pagination)

    async def create_employee(
        self, employee: CreateEmployeeSchema
    ) -> EmployeeOutSchema:
        employee_dto = EmployeeBaseDTO(**employee.model_dump())
    ...
    async def get_employee(self, id: UUID) -> Optional[EmployeeOutSchema]:
        employee = await self.employee_use_case.get_employee(id)
        return EmployeeOutSchema(**employee.model_dump())

    async def update_employee(
        self, id: UUID, employee: UpdateEmployeeSchema
    ...
    async def delete_employee(self, id: UUID) -> bool:
        return await self.employee_use_case.delete_employee(id)
